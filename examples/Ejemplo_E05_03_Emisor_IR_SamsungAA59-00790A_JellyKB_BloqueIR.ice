{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "c20d8a31-d0cc-4b5f-9d50-378d1350788a",
          "type": "basic.output",
          "data": {
            "name": "led",
            "range": "[4:0]",
        ...
        {
          "id": "9d89ccea-394b-4d9c-ae77-f8ad91a92a94",
          "type": "basic.output",
          "data": {
            "name": "Fila",
            "range": "[5:0]",
        ...
        {
          "id": "6e6cd3a8-2ef7-4c74-a658-a0684c8fe462",
          "type": "basic.input",
          "data": {
            "name": "Col",
            "range": "[4:0]",
        ...
        {
          "id": "18bfdc58-ab21-44a7-8ff7-ede04f40a845",
          "type": "basic.input",
          "data": {
            "name": "ReceptorIR",
            "pins": [
        ...
        {
          "id": "adce8358-d3ff-44d8-bd3a-c8b7c30faaa1",
          "type": "basic.output",
          "data": {
            "name": "ch0",
            "pins": [
        ...
        {
          "id": "41ebb309-2f8c-4141-80e9-597b87a6204d",
          "type": "basic.memory",
          "data": {
            "name": "Codigos",
            "list": "00000000000000000000000000000000\n00000000000000000000000000000000\n11100000111000001000011001111001    // Flecha abajo\n00000000000000000000000000000000\n11100000111000001010011001011001    // Flecha izquierda\n00000000000000000000000000000000\n11100000111000000100011010111001    // Flecha derecha\n00000000000000000000000000000000\n11100000111000000000011011111001    // Flecha arriba\n00000000000000000000000000000000\n11100000111000000100000010111111    // Encender-Apagar\n11100000111000001001111001100001    // HUB SMART\n00000000000000000000000000000000\n11100000111000001011010001001011    // Exit\n11100000111000001101000000101111    // Volumen -\n11100000111000001110000000011111    // Volumen +\n11100000111000000001011011101001    // ENTER\n00000000000000000000000000000000\n00000000000000000000000000000000\n00000000000000000000000000000000\n00000000000000000000000000000000\n00000000000000000000000000000000\n00000000000000000000000000000000\n00000000000000000000000000000000\n00000000000000000000000000000000\n00000000000000000000000000000000\n00000000000000000000000000000000\n00000000000000000000000000000000\n00000000000000000000000000000000\n00000000000000000000000000000000\n00000000000000000000000000000000\n00000000000000000000000000000000\n\n\n",
            "local": false,
            "format": 10
          },
          "position": {
        ...
        {
          "id": "2e6b2f0a-73a6-4160-b28a-9110dfcb543c",
          "type": "bc4c58978ea6aa891d960fba90ffaa0a8c3d6960",
          "position": {
            "x": -1200,
            "y": 0
          },
        ...
        {
          "id": "cb68b67a-b3e8-4608-a0ae-772cab9a149a",
          "type": "1e2fa206073eaf5783579d7ff043236d62e6807c",
          "position": {
            "x": -1400,
            "y": -144
          },
        ...
        {
          "id": "63492e52-6fd0-4483-9ba2-e2e85512cb5f",
        ...
        {
          "id": "84db86fb-9d2d-4e60-ac1f-13cc2685e9e9",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "b2dd1c9c-7ff8-44f8-a80e-115b2b82ee43",
          "type": "basic.info",
          "data": {
            "info": "Esta parte del circuito es opcional . Solamente la usaremos en caso de recibir los códigos a través de nuestro Alhambra receptorIR para enviarlos a su vez al PC mediante un canal del analizador digital",
            "readonly": true
          },
          "position": {
            "x": -816,
        ...
        {
          "id": "7cbdbca5-8bac-4e9c-9336-d84eeca7e20a",
          "type": "basic.info",
          "data": {
            "info": "Aquí tenemos que conectar nuestro Alhambra EmisorIR",
            "readonly": true
          },
          "position": {
            "x": -1088,
        ...
        {
          "id": "9c53f9b0-8869-4986-8ea1-449bbc0143ce",
          "type": "basic.info",
          "data": {
            "info": "Bloque del circuito **EmisorIR_NECext**",
            "readonly": true
          },
          "position": {
            "x": -1208,
        ...
        {
          "id": "2b73ca09-a2a6-48cc-8a55-7862e62f218f",
          "type": "basic.info",
          "data": {
            "info": "## Teclado Jelly Comb hackeado por @Obijuan\n\n### Tabla con la relación de teclas y su correspondiente código en hexadecimal",
            "readonly": true
          },
          "position": {
            "x": -776,
        ...
        {
          "id": "ba43860e-2fcd-423a-9e2a-32829ce1a964",
          "type": "basic.info",
          "data": {
            "info": "#### Tabla de asignación entre los códigos de las teclas del teclado Jelly Comb y los códigos de 32 bits correspondientes al mando TV que pretendemos emular",
            "readonly": true
          },
          "position": {
            "x": -1392,
        ...
        {
          "id": "27cc4249-f6dd-448f-80a5-77c98b05b7ec",
          "type": "basic.info",
          "data": {
            "info": "Bloque de código para manejar el teclado Jelly Comb de 18 teclas",
            "readonly": true
          },
          "position": {
            "x": -1760,
        ...
        {
          "id": "4a7b22cd-d9a1-447d-93f7-1534227aae1e",
          "type": "basic.info",
          "data": {
            "info": "# MakerVentura :\n## Proyecto Control y Comunicación por Infrarrojos :\n## Ejemplo E05_03 . Emulación de un mando TV inalámbrico Samsung referencia AA59-00790A\n### Uso de un teclado Jelly Comb hackeado con 18 teclas para activar 10 botones del mando diferentes\n\nCon este Ejemplo E05_03 , utilizamos un teclado de 18 pulsadores para seleccionar dentro de una tabla el código de 32 bits que corresponde con el botón del mando que pretendemos emular , y este se lanza a través de nuestro **Alhambra EmisorIR** el código al televisor",
            "readonly": true
          },
          "position": {
            "x": -2304,
        ...
        {
          "id": "18061b6d-e111-4551-bdff-0ec296c2a2ad",
        ...
        {
          "id": "44942a15-9a20-4a96-aa27-b61470c7eda7",
        ...
        {
          "id": "5a4ba964-336f-4914-b582-057051d89a03",
        ...
        {
          "id": "10dea1df-3c57-451f-930b-2134eeebf29b",
        ...
        {
          "id": "125d84a8-f7bf-47dd-855f-e333b752b54d",
          "type": "basic.info",
          "data": {
            "info": "<img src=\"https://raw.githubusercontent.com/makerventura/Mundo_FPGA_libre/master/Imagenes/IMG_20190428_210329.jpg\" width=400 > </img>",
            "readonly": true
          },
          "position": {
            "x": -432,
        ...
        {
          "id": "482fa99b-b82d-4c32-9887-bf6c91ca5a40",
          "type": "basic.info",
          "data": {
            "info": "### Mando Samsung AA59-00790A con las teclas decodificadas que utilizamos en este Ejemplo",
            "readonly": true
          },
          "position": {
            "x": -432,
        ...
        {
          "id": "1b9d9e0f-8ddd-4e40-8050-811dc32dc876",
          "type": "basic.info",
          "data": {
            "info": "#### Correlación entre las teclas del Teclado Jelly y la botonera del Mando TV",
            "readonly": true
          },
          "position": {
            "x": -2240,
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "2e6b2f0a-73a6-4160-b28a-9110dfcb543c",
            "port": "82a289d9-5dc9-41ed-a21a-995bb95e47e3"
          }
        },
        {
          "source": {
            "block": "2e6b2f0a-73a6-4160-b28a-9110dfcb543c",
            "port": "b10148e1-e4d3-4af4-ae9e-519f2511dc00"
          },
          "target": {
        ...
        {
          "source": {
            "block": "41ebb309-2f8c-4141-80e9-597b87a6204d",
            "port": "memory-out"
          },
          "target": {
            "block": "cb68b67a-b3e8-4608-a0ae-772cab9a149a",
        ...
        },
        {
          ...
          "target": {
            "block": "2e6b2f0a-73a6-4160-b28a-9110dfcb543c",
            "port": "9db5a37b-d315-404b-b4f2-dcc1a9ad2a95"
          },
          "vertices": [],
          "size": 32
        },
        {
          "source": {
            "block": "63492e52-6fd0-4483-9ba2-e2e85512cb5f",
            "port": "b603fff0-ba56-4cfd-b47e-7ca0aa8fe5f0"
          },
          "target": {
            "block": "9d89ccea-394b-4d9c-ae77-f8ad91a92a94",
            "port": "in"
          },
          "vertices": [],
          "size": 6
        ...
        {
          "source": {
            "block": "6e6cd3a8-2ef7-4c74-a658-a0684c8fe462",
            "port": "out"
          },
          "target": {
            "block": "63492e52-6fd0-4483-9ba2-e2e85512cb5f",
        ...
        },
        {
          ...
          "target": {
            "block": "c20d8a31-d0cc-4b5f-9d50-378d1350788a",
            "port": "in"
          },
          "vertices": [],
          "size": 5
        },
        {
          ...
          "target": {
            "block": "2e6b2f0a-73a6-4160-b28a-9110dfcb543c",
            "port": "989041e3-4556-4b34-9b5c-7509d44fb0e8"
          },
          "vertices": [
            {
              "x": -1376,
        ...
        {
          "source": {
            "block": "18bfdc58-ab21-44a7-8ff7-ede04f40a845",
            "port": "out"
          },
          "target": {
            "block": "adce8358-d3ff-44d8-bd3a-c8b7c30faaa1",
            "port": "in"
          }
        }
      ]
  ...
  "dependencies": {
    "bc4c58978ea6aa891d960fba90ffaa0a8c3d6960": {
      "package": {
        "name": "Emisor_IR_NEC32ext_Bloque",
        "version": "1.0",
        "description": "Emisor de IR segun protocolo NEC-32 extendido . 38 Khz por defecto . El codigo de 32 bits se introduce por Codigo[31:0] . La señal de envío se conecta por la entrada ",
        "author": "MakerVentura",
    ...
    "1e2fa206073eaf5783579d7ff043236d62e6807c": {
      "package": {
        "name": "mi-tabla5-32",
        "version": "0.1",
        "description": "Circuito combinacional de 5 entradas y 32 salidas",
