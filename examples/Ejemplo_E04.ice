{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "56145826-80ab-4c70-9a83-7ae0bcaf7ecf",
          "type": "basic.output",
          "data": {
            "name": "Leds",
            "range": "[7:0]",
        ...
        {
          "id": "82d4d74d-52f2-4049-976e-4138d83757e9",
          "type": "basic.output",
          "data": {
            "name": "Emisor",
            "pins": [
        ...
        {
          "id": "2e9d5a4c-7d16-45db-9dd5-1ea0d20b993c",
          "type": "basic.input",
          "data": {
            "name": "Receptor",
            "pins": [
        ...
        {
          "id": "461378ba-2cba-4e78-9692-d8b968d7a039",
          "type": "basic.output",
          "data": {
            "name": "led_receptor",
            "pins": [
        ...
        {
          "id": "4e789b88-3558-4af7-9711-614320fe0a3f",
          "type": "basic.output",
          "data": {
            "name": "led_emisor",
            "pins": [
        ...
        {
          "id": "0959ae2b-8881-498e-b0bf-6fb33fcbb374",
          "type": "basic.constant",
          "data": {
            "name": "sec",
            "value": "1",
        ...
        {
          "id": "20e058ba-a724-4403-a4f0-50f107569683",
          "type": "basic.constant",
          "data": {
            "name": "num_1",
            "value": "170",
        ...
        {
          "id": "eb1f14a8-7801-4a09-b1af-49b7b3ac1219",
          "type": "basic.constant",
          "data": {
            "name": "num_0",
            "value": "240",
        ...
        {
          "id": "1311d3fd-042b-4fc5-95e3-32c111ac5721",
          "type": "basic.constant",
          "data": {
            "name": "Hz",
            "value": "38000",
        ...
        {
          "id": "703d3f1d-1ad4-4fc5-a7bc-096b0599df65",
          "type": "basic.constant",
          "data": {
            "name": "msec",
            "value": "10",
        ...
        {
          "id": "ec7eb4f8-aff5-4fcc-aa43-754299f8b9b8",
          "type": "basic.constant",
          "data": {
            "name": "msec",
            "value": "10",
        ...
        {
          "id": "d75034ae-c79d-4534-bf6c-8b6005afe39c",
        ...
        {
          "id": "a56f97b3-f23d-408a-9681-fe85cbd03c46",
          "type": "f91a2729e24bdc5bb7370785202c65c6526d7a01",
          "position": {
            "x": 536,
            "y": 424
        ...
        {
          "id": "05168d89-b7ba-4690-b9c6-90b41e6744f9",
          "type": "basic.info",
          "data": {
            "info": "# MakerVentura :\n## Proyecto Control y Comunicación por Infrarrojos :\n## Ejemplo E04 : Trabajando con los bloques de comunicación asíncrona por infrarrojos de 8 bits con temporización de emisión y recepción constantes\n## Bloque emisor Serial-tx-IR // Bloque receptor Serial-rx-IR\n### Transmisión de dos numeros cualquiera de 8 bits alternativamente cada segundo , mostrándo su estado en los leds de la Icezum Alhambra\n\nCon este ejemplo lo que se hace es seleccionar dos números cualquiera de 8 bits y se introducen alternativamnete al bloque Serial-tx-IR . En dicho bloque se selecciona la frecuencia de modulación correspondiente al fototransistor que estemos usando en nuestro receptor ( En nuestro caso 38 KHz = 38000 Hz ) .\n\nEl periodo de alternancia en la transmisión es en este caso de 1 segundo , y una vez comienza la misma ,los 8 bits de nuestro dato se trasmiten en serie con un periodo constante entre bit y bit marcado por el cronómetro interno de nuestro bloque emisor (600 microsec). Al terminar de enviar los 8 bits , envía un tic por la puerta \"done\" que aprovechamos para encender durante 10 msec un led de aviso .\n\nSimultaneamente nuestro receptor Serial-tx-IR va registrando los 8 bits conforme le van llegando , y al completar la recepción del byte , envía los 8 bits a los leds internos de la placa , mostrando el número seleccionado en binario . Al acabar con la recepción , envía un tic a una cronómetro que aprovechamos para encender otro led que avisa del final de la recepción .",
            "readonly": true
          },
          "position": {
            "x": -1432,
        ...
        {
          "id": "fb8f954c-2e00-4889-ac90-b7e222d155e5",
        ...
        {
          "id": "b91c3cd6-59af-4025-9bef-3df7db5a60d4",
        ...
        {
          "id": "362f4984-24f3-44df-8658-515510b9b75a",
        ...
        {
          "id": "acd921ad-6be7-4279-b803-b733120ad692",
        ...
        {
          "id": "11351585-d23e-4f72-8730-e9df69f06268",
          "type": "basic.info",
          "data": {
            "info": "Con este ejemplo avanzamos un paso más en la complejidad del formato de datos a comunicar . ( Leer previamente el Tema 30 dedicado por @Obijuan a mostrar el funcionamiento de los puertos serie en este enlace >> https://github.com/Obijuan/digital-electronics-with-open-FPGAs-tutorial/wiki/V%C3%ADdeo-30:-Puerto-serie ) . Con la misma filosofía de comunicación asíncrona de los puertos serie , buscamos una manera de enviar por el canal de infrarrojos un byte de datos ( 8 bits ). En este protocolo de comunicación los 8 bits del byte de datos los enviamos en formato serie con una separación temporal entre ellos constante de 600 microsegundos debido a los tiempos de encendido y apagado recomendados por el fabricante de estos leds IR para evitar que se estropee .\r\n\r\nVolvemos a fusionar **comunicación** con **control** , dado que por una parte por el **canal infrarrojo** somos capaces de enviar a una cierta distancia un dato de 1 byte , y por otro , una vez recibido el mismo , en función de su valor podemos ejecutar diversas acciones y controles ( mover actuadores , asignar sonidos , colores , palabras , ...).\r\n\r\nEste formato de comunicación no distingue **temporalmente** entre el envío de un \"0\" lógico y un \"1\" lógico , como veremos en el protocolo NEC posteriormente.",
            "readonly": true
          },
          "position": {
            "x": 184,
        ...
        {
          "id": "4eee9eea-c479-4ffc-aa7f-4f13b26837da",
          "type": "basic.info",
          "data": {
            "info": "Conectar en este pin el **Alhambra_EmisorIR**",
            "readonly": true
          },
          "position": {
            "x": -376,
        ...
        {
          "id": "4103e9a6-4cbc-4985-96fe-6c3096683b2e",
          "type": "basic.info",
          "data": {
            "info": "Indicar aquí la frecuencia de modulación que corresponde al fototransitor utilizado",
            "readonly": true
          },
          "position": {
            "x": -760,
        ...
        {
          "id": "fe95fc9f-dc65-405e-829f-da7229c60d75",
          "type": "basic.info",
          "data": {
            "info": "Seleccionar dos numeros cualquiera de 8 bits del 0 al 255",
            "readonly": true
          },
          "position": {
            "x": -1008,
        ...
        {
          "id": "ae87b13a-699c-459c-b1c0-61e53690c542",
          "type": "basic.info",
          "data": {
            "info": "Este led se enciende 10 msec al acabar la emisión de los 8 bits del dato",
            "readonly": true
          },
          "position": {
            "x": -240,
        ...
        {
          "id": "489eb21c-e572-497f-af85-5720ba175d69",
          "type": "basic.info",
          "data": {
            "info": "Conectar en este pin el **Alhambra_ReceptorIR**",
            "readonly": true
          },
          "position": {
            "x": 24,
        ...
        {
          "id": "1f1c76af-10e9-4a87-acb3-534130a532f7",
          "type": "basic.info",
          "data": {
            "info": "Serial-tx-IR: Bloque encargado de la transmisión en serie asíncrona de los 8 bits con un periodo de 600 microsec",
            "readonly": true
          },
          "position": {
            "x": -632,
        ...
        {
          "id": "36ff873a-fd8d-4d61-845f-e723bc79e8bb",
          "type": "basic.info",
          "data": {
            "info": "Serial-rx_IR: Bloque encargado de recibir y registar los 8 bits enviados por el emisor.",
            "readonly": true
          },
          "position": {
            "x": 256,
        ...
        {
          "id": "3c51b993-9fc0-4a3e-93f7-8a6f1c91ea6f",
          "type": "basic.info",
          "data": {
            "info": "Al terminar la receptción de los 8 bits se enciende el led_emisor 10 msec",
            "readonly": true
          },
          "position": {
            "x": 528,
        ...
        {
          "id": "f22290e6-789e-4780-9baf-87fb65665845",
          "type": "basic.info",
          "data": {
            "info": "El numero seleccionado se muestra en binario en los 8 leds internos de la placa",
            "readonly": true
          },
          "position": {
            "x": 936,
        ...
        {
          "id": "b3c6a4c8-8ac0-4e54-90ce-d9929f06577d",
          "type": "d0b74a256664808d103ab0620944ca9a0cb8d5de",
          "position": {
            "x": -568,
            "y": 336
          },
        ...
        {
          "id": "ed0304d5-7f8b-4840-ae19-9f15bb412531",
        ...
        {
          "id": "ef0f0ae9-be17-49ca-8c57-96996d06e8b7",
          "type": "368be12a844dc2d9747e343499692bedc4af1a49",
          "position": {
            "x": 296,
            "y": 240
          },
        ...
        {
          "id": "503f5f08-7b72-4b2a-9c01-02f823ccab14",
          "type": "5ad97e1e35a295d0ec722addd6df97c806fc6b7c",
          "position": {
            "x": -1224,
            "y": 504
        ...
        {
          "id": "ea2650e7-319a-4f21-aaef-d8496bd199e7",
        ...
        {
          "id": "f9c222a3-0109-4193-a12e-5c6ebe19fc89",
        ...
        {
          "id": "698f1889-cad8-4190-a7a7-02a60b7f95fd",
        ...
        {
          "id": "7e9a365a-9215-4007-b3a4-c2ff815f9c4e",
          "type": "basic.info",
          "data": {
            "info": "Cada segundo enviamos alternativamente uno de los dos numeros seleccionados",
            "readonly": true
          },
          "position": {
            "x": -944,
      ...
      "wires": [
        {
          "source": {
            "block": "d75034ae-c79d-4534-bf6c-8b6005afe39c",
            "port": "c45dab76-9d0f-4742-9e4d-3048637d245d"
          },
          "target": {
            "block": "4e789b88-3558-4af7-9711-614320fe0a3f",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "1311d3fd-042b-4fc5-95e3-32c111ac5721",
            "port": "constant-out"
          },
          "target": {
            "block": "b3c6a4c8-8ac0-4e54-90ce-d9929f06577d",
            "port": "086bf341-e6dd-4dee-b089-6b78c1e82e39"
          },
          "vertices": []
        },
        {
          ...
          "target": {
            "block": "82d4d74d-52f2-4049-976e-4138d83757e9",
            "port": "in"
          }
        },
        {
        ...
        {
          "source": {
            "block": "a56f97b3-f23d-408a-9681-fe85cbd03c46",
            "port": "c45dab76-9d0f-4742-9e4d-3048637d245d"
          },
          "target": {
            "block": "461378ba-2cba-4e78-9692-d8b968d7a039",
            "port": "in"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "ec7eb4f8-aff5-4fcc-aa43-754299f8b9b8",
            "port": "constant-out"
          },
          "target": {
            "block": "a56f97b3-f23d-408a-9681-fe85cbd03c46",
        ...
        {
          "source": {
            "block": "703d3f1d-1ad4-4fc5-a7bc-096b0599df65",
            "port": "constant-out"
          },
          "target": {
            "block": "d75034ae-c79d-4534-bf6c-8b6005afe39c",
        ...
        {
          "source": {
            "block": "20e058ba-a724-4403-a4f0-50f107569683",
            "port": "constant-out"
          },
          "target": {
            "block": "ed0304d5-7f8b-4840-ae19-9f15bb412531",
            "port": "c0fb4784-5e8c-4f41-9f4b-6daa2e9e03a4"
          }
        },
        {
          "source": {
            "block": "2e9d5a4c-7d16-45db-9dd5-1ea0d20b993c",
            "port": "out"
          },
          "target": {
            "block": "ef0f0ae9-be17-49ca-8c57-96996d06e8b7",
            "port": "818b823d-fbef-4a14-bc41-11c1bea33c72"
          },
          "vertices": [
            {
              "x": 208,
        ...
        },
        {
          "source": {
            "block": "ef0f0ae9-be17-49ca-8c57-96996d06e8b7",
            "port": "efcc64ff-f6b4-4ba9-b562-9bbf28a6097d"
          },
          "target": {
            "block": "a56f97b3-f23d-408a-9681-fe85cbd03c46",
            "port": "61d11f03-6fbc-4467-a947-d546fa6f6429"
        ...
        },
        {
          "source": {
            "block": "ef0f0ae9-be17-49ca-8c57-96996d06e8b7",
            "port": "61340769-f3c1-45d9-a1da-e76adf4e3387"
          },
          "target": {
            "block": "56145826-80ab-4c70-9a83-7ae0bcaf7ecf",
            "port": "in"
          },
          "size": 8
        },
        {
          "source": {
            "block": "eb1f14a8-7801-4a09-b1af-49b7b3ac1219",
            "port": "constant-out"
          },
          "target": {
            "block": "503f5f08-7b72-4b2a-9c01-02f823ccab14",
            "port": "c0fb4784-5e8c-4f41-9f4b-6daa2e9e03a4"
          },
          "vertices": []
        },
        {
          ...
          "target": {
            "block": "ea2650e7-319a-4f21-aaef-d8496bd199e7",
        ...
        {
          "source": {
            "block": "0959ae2b-8881-498e-b0bf-6fb33fcbb374",
            "port": "constant-out"
          },
          "target": {
            "block": "f9c222a3-0109-4193-a12e-5c6ebe19fc89",
        ...
        },
        {
          ...
          "target": {
            "block": "698f1889-cad8-4190-a7a7-02a60b7f95fd",
  ...
  "dependencies": {
    ...
    "d0b74a256664808d103ab0620944ca9a0cb8d5de": {
      "package": {
        "name": "Serial-tx-IR",
        "version": "1.0",
    ...
    "368be12a844dc2d9747e343499692bedc4af1a49": {
      "package": {
        "name": "Serial-rx-IR",
        "version": "1.0",
        "description": "Receptor serie asíncrono 8 bits.Sensor IR",
        "author": "Versión MakerVentura IR del bloque Serial-rx de Obijuan",
        "image": ""
      },
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "813e633d-45f0-41a0-a029-4c36fe804db3",
              "type": "basic.constant",
              "data": {
                "name": "delay_inic",
                "value": "300",
            ...
            {
              "id": "947647be-067a-4f12-a893-5a49e7e6c753",
              "type": "b959c256104d1064a5ef7b38632ffb6eed3b396f",
              "position": {
                "x": 552,
                "y": 168
            ...
            {
              "id": "b82a58d2-15c5-42c0-b9d4-6cd22560ee24",
            ...
            {
              "id": "74e520f7-38ed-4e6e-8290-f4dd25fabc8d",
              "type": "450b558792ccc05823c712394b9cfa1a2d8f268b",
              "position": {
                "x": 1080,
                "y": -184
            ...
            {
              "id": "9a0a6798-049d-41ba-9bd8-1508f53e86df",
              "type": "1c7dae7144d376f2ee4896fcc502a29110e2db37",
              "position": {
                "x": 1504,
                "y": 144
            ...
            {
              "id": "a72e89fc-48e4-4717-a23f-b9008d304b9b",
              "type": "2cb0b366b18a00e12ffc963c4a8fcc7749606859",
              "position": {
                "x": 136,
                "y": 32
            ...
            {
              "id": "da0952cd-1976-43e7-8446-a9aacec788ef",
              "type": "basic.info",
              "data": {
                "info": "**Cable**  \nUn simple cable, para  \norganizar mejor las  \nconexiones del reloj  ",
                "readonly": true
              },
              "position": {
                "x": 136,
            ...
            },
            {
              ...
              "type": "basic.info",
              "data": {
                "info": "**Condición de arranque:**  \nLlega el bit de start  \nque es 1. El sensor al detectarlo se pone a 0. Detectamos  \nel flanco de bajada que provoca",
                "readonly": true
              },
              "position": {
                "x": 288,
            ...
            {
              "id": "f888d91c-a522-407e-a995-a28401dd3cd5",
              "type": "621e64c5f8538d8fc2e5d512d025e7aea75cfa22",
              "position": {
                "x": 720,
                "y": 168
            ...
            {
              "id": "ffd5a22e-b1c8-441f-a7a9-ec25497ecfff",
            ...
            {
              "id": "ac90d40d-4a68-4392-b7d5-6d567b51b827",
            ...
            {
              "id": "8f053456-d2f0-4201-b0c1-25c764217a42",
              "type": "35f267d0df6ffcb7fc33753bc9df9cf083642cca",
              "position": {
                "x": 720,
                "y": -168
            ...
            {
              "id": "4e881dc5-7919-4cfc-8429-a89c0cbdf7dd",
              "type": "basic.info",
              "data": {
                "info": "La señal que sale del fototransistor llega **invertida** , por lo que tenemos que pasarla por una **puerta NOT** para recuperar el código real del número enviado por el emisor",
                "readonly": true
              },
              "position": {
                "x": 648,
            ...
            {
              "id": "466373bf-10af-4c81-8dec-5ec0dda9ae8e",
              "type": "basic.info",
              "data": {
                "info": "Debido posiblemente a la inercia térmica del LED IR los tiempos de emisión de los \"0\" y \"1\" no son exactamente 600 microsec.Por eso retrasamos la lectura inicial 300 microsec , de manera que las lecturas coincidan con el punto central de emisión siempre y nos evitamos inestabilidad en la lectura de los códigos enviados",
                "readonly": true
              },
              "position": {
                "x": 320,
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "ffd5a22e-b1c8-441f-a7a9-ec25497ecfff",
                "port": "b6426b43-dcda-418d-b6d3-4764b5bc0b25"
              },
              "vertices": []
            },
            {
              ...
              "target": {
                "block": "74e520f7-38ed-4e6e-8290-f4dd25fabc8d",
                "port": "ec65c3cd-0951-4d74-bbfc-c37f87a78e66"
              }
            },
            {
              "source": {
                "block": "947647be-067a-4f12-a893-5a49e7e6c753",
                "port": "1cb167a4-9e2a-416b-803e-da7b6151eaa5"
              },
              "target": {
                "block": "cf9bdb75-0aa0-4807-bdcb-24e6c3dc14be",
            ...
            },
            {
              ...
              "target": {
                "block": "b82a58d2-15c5-42c0-b9d4-6cd22560ee24",
            ...
            },
            {
              "source": {
                "block": "74e520f7-38ed-4e6e-8290-f4dd25fabc8d",
                "port": "695fa349-398b-468e-bc4c-5ba89f92fe97"
              },
              "target": {
            ...
            },
            {
              ...
              "target": {
                "block": "9a0a6798-049d-41ba-9bd8-1508f53e86df",
                "port": "bf2f0c53-2d04-4cba-aa70-2df85502d24f"
              }
            },
            {
            ...
            {
              "source": {
                "block": "f888d91c-a522-407e-a995-a28401dd3cd5",
                "port": "c138a610-b61f-4e7c-bb8a-c4f3b0b9f95c"
              },
              "target": {
                "block": "4d5c8485-c91b-4f0c-8b21-8b788394a9bc",
            ...
            {
              "source": {
                "block": "a72e89fc-48e4-4717-a23f-b9008d304b9b",
                "port": "76f5099a-54df-47eb-b828-f2ab2f211687"
              },
              "target": {
                "block": "4d5c8485-c91b-4f0c-8b21-8b788394a9bc",
            ...
            },
            {
              ...
              "target": {
                "block": "ac90d40d-4a68-4392-b7d5-6d567b51b827",
                "port": "61d11f03-6fbc-4467-a947-d546fa6f6429"
              }
            },
            {
            ...
            {
              "source": {
                "block": "813e633d-45f0-41a0-a029-4c36fe804db3",
                "port": "constant-out"
              },
              "target": {
                "block": "ac90d40d-4a68-4392-b7d5-6d567b51b827",
            ...
            {
              "source": {
                "block": "8f053456-d2f0-4201-b0c1-25c764217a42",
                "port": "664caf9e-5f40-4df4-800a-b626af702e62"
              },
              "target": {
                "block": "74e520f7-38ed-4e6e-8290-f4dd25fabc8d",
